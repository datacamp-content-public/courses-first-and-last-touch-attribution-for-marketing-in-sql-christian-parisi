...
`@script`
Welcome back to First and Last Touch attribution for marketing in SQL with Christian Paris.  Now that we've covered last touch attribution, let's discuss first touch attribution and some of the things we need to consider when using SQL to perform this type of analysis.
